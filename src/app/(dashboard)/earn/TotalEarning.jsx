...
const data = [
  {
    progress: 75,
    title: 'ZPH mining',
    amount: '24,895.65 zph',
    subtitle: 'Earned by being active on the network',
    imgSrc: '/images/cards/zipcar.png'
  },
  {
    progress: 50,
    color: 'info',
    title: 'ZPH Team reward',
    amount: '8,650.20 zph',
    subtitle: 'Earned by team activity.',
  ...
  },
  {
    ...
    color: 'secondary',
    amount: '1,245.80 zph',
    subtitle: 'Earn ZPH by completing tasks and other eco-friendly actions',
      ...
      <CardContent className='flex flex-col gap-11 md:mbs-2.5'>
        <div>
          <div className='flex items-center justify-between- gap-6'>
            <Typography variant='h3'> 240,895 ZPH</Typography>
            <div  className='flex '>
          ...
          <Typography>Compared to 84,325 ZPH last month</Typography>
        </div>
            ...
            <div key={index} className='flex items-center gap-3'>
              ...
              <div className='flex justify-between items-center is-full flex-wrap- gap-x-4 gap-y-2'>
                <div className='flex flex-col gap-0.5'>
                  ...
                  <Typography className='text-[12px]'>{item.subtitle}</Typography>
                </div>
